...
function generateReceipt(invoice) {
    ...
    doc.registerFont('header', __dirname + '/fonts/Lato-Medium.ttf', 'Lato-Medium');
    doc.registerFont('text', __dirname + '/fonts/Lato-Light.ttf', 'Lato-Light');
    
    // Place logo
    doc.image(__dirname + '/images/payme_logo_blue.png', 10, 10, {scale: 0.25});
